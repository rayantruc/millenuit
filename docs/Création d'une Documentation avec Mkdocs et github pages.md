...
Obsidian sert d'éditeur de texte en markdown pour nous faciliter la création de la documentation, il permetteras aussi d'éffectuer le lien avec git a l'aide d'une éxtension et -
